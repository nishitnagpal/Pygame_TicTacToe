...
function drawGrid() {
    ...
    const startX = (WIDTH - 3 * SQUARE_SIZE) / 2;
    const startY = (HEIGHT - 3 * SQUARE_SIZE) / 2;
    ...
    if (gameStarted) {
        ...
        ctx.fillText('Play with computer', WIDTH / 5 , HEIGHT / 3 );
        ctx.fillText('2 Players Game', WIDTH / 2 , HEIGHT / 3 );
